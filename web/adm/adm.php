				...
				<div class="col-sm-12 main">
					<div class="page-header">
	                    ...
	                    <div class="btn-group margin-right pull-right" style="margin-top:20px;">
	                    	<a href="addShow.php" class="btn btn-info">Adicionar Show</a>
	                    	<a href="add.php" class="btn btn-info">Adicionar Novo Estabelecimento</a>
							<a href="category.php" class="btn btn-info">Adicionar Categorias Cardápio</a>
							<a href="subtypes.php" class="btn btn-success">Adicionar Subcategorias</a>
							<a href="ads.php" class="btn btn-warning">Anúncios</a>
	                    </div>
	                    <div class="clear"></div>
	                </div>
					...
					<?php $ctg = ""; for($i = 0; $i < sizeof($lojas); $i++) { ?>
						<?php 
							if ($ctg != $lojas[$i]['NomeCategoria']) {
								...
								echo utf8_encode($lojas[$i]['NomeCategoria']) . '<br>';
								echo '<hr>';
							}
						?>
						<div class="well well-sm" style="float:left; margin-right: 10px; margin-bottom: 10px; width: 470px;">
