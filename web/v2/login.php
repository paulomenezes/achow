<?php
    ...
    $helper = new FacebookRedirectLoginHelper( 'http://www.achow.com.br/v2/login.php' );
        ...
        <div class="login-view mdl-grid">
            ...
            <div class="login mdl-cell mdl-cell--4-col mdl-cell--12-col-phone  mdl-cell--12-col-tablet">
                <div ng-show="login">
                    ...
                    <form name="loginForm" method="POST" action="/v2/login.php">
                ...
                <div ng-hide="login" class="register">
                    ...
                    <form class="mdl-grid" name="registerForm" method="POST" action="/v2/login.php">
